<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="AplicacionWeb.Error" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container center-row grande">
            <div class="col-7">
                <div class="card text-center mt-5 bg-black bg-opacity-75 bg-gradient text-bg-danger">
                    ...
                    <div class="card-footer text-muted">
                        ...
                        %>
                        <asp:Button ID="btnLogin" runat="server" Text="Iniciar Sesión" CssClass="btn btn-outline-light btn-primary w-170" OnClick="btnLogin_Click" />
