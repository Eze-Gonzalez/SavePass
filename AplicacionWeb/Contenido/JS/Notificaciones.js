...
function crearAlerta(status, titulo, mensajeN) {
    ...
    if (titulo === "Email ya registrado" && mensaje != "El email ingresado ya se encuentra registrado, por favor, verifique el email e intente nuevamente.") {
    ...
    if (titulo === "Servicio Agregado" || titulo === "Servicio Actualizado") {
        boton.onclick = function() {
            modal.style.display = "none";
            window.location.href = "MyServices.aspx";
        }
    }
